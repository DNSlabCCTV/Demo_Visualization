...
*/
    ...
    socket_local.on("showList",function(data){
      ...
      $(divname).empty();
      var $ul = $('<ul id="'+data[0].OBOX+'"style="wdith:100%; height:80%; list-style:none; padding-left:0px; overflow:auto;"></ul>')
      $(divname).append($ul);
      for(var i=0 ; i< data.length ; i++){  
        ...
        var $li = $('<li id="'+path_name+'" onclick="select_vid(this)"" style="font-size:30px; text-align:center;">'+vid_name[vid_name.length - 1]+'</li>')
        $($ul).append($li);
      }
    })
   ...
   socket_local.on("aiList",function(data){
      ...
      $(divname).empty();
      var $ul = $('<ul id="'+data[0].OBOX+'_ai" style="wdith:100%; height:100%; list-style:none; padding-left:0px; overflow:auto;"></ul>')
      $(divname).append($ul);
      for(var i=0 ; i< data.length ; i++){
        var vid_name = data[i].PATH.split("/");
        var path_name = "";
        ...
        var $li = $('<li id="'+path_name+'" onclick="select_vid(this)"" style="font-size:30px; text-align:center;">'+vid_name[vid_name.length-2]+' '+vid_name[vid_name.length - 1]+'</li>')
        $($ul).append($li);
      }
   })
